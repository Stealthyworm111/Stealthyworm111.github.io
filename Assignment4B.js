...
let person = {
  ...
  lastName: "Doe",
  age: 45,
  streetAddress: "100 CIS255 Str",
  city: "University Center Mi",
  state: "Michigan",
  zipCode: "48710",
...
appendTableRow4(table3b,"Thingamabob","1","1","");
appendTableRow4(table3b,"Whachamacallit","2","2","");
appendTableRow4(table3b,"Doohickey","3","3","");
appendTableRow4(table3b,"Grand Total","","","14");
...
function appendTableRow4 (tableobj, col1, col2, col3,col4) 
{
  ...
  td2.innerHTML = col2;
  td3.innerHTML = col3;
  if(isNaN(col2 * col3)|| col2 =="")
    td4.innerHTML = col4;
  else
       td4.innerHTML = col2 * col3;
